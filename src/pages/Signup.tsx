...
/**
 * IMPORTANT: To enable Google Sign-Up, you need to:
 * 1. Go to Supabase Dashboard → Authentication → Providers
 * 2. Enable Google provider
 * 3. Add your Google OAuth Client ID and Secret
 * 4. Add authorized redirect URLs (e.g., http://localhost:5173/auth/callback)
 *
 * Note: When users sign up with Google OAuth, Supabase automatically creates
 * the user in auth.users. You may need to set up a database trigger to create
 * the profile record automatically, or handle it in your application logic.
 */
...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        // Calculate beta end date (45 days from now)
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Get started with BrayorAI today
            </p>
          </div>
